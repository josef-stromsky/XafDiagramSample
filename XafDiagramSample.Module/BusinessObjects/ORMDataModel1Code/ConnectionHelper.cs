...
namespace XafDiagramSample.Module.BusinessObjects.DiagramTest
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(ProcessingNode),
            typeof(ProcessingFlowOutput),
            typeof(ProcessingFlowInput),
            typeof(ProcessingFlow),
            typeof(MonitoringBoard)
        };
        ...
        public const string ConnectionStringName = ".DiagramTest";
